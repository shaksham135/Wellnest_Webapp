...
-- These ensure existing production tables get updated with new columns
ALTER TABLE users ADD COLUMN IF NOT EXISTS fcm_token VARCHAR(255);
ALTER TABLE users ADD COLUMN IF NOT EXISTS target_steps INT;
ALTER TABLE users ADD COLUMN IF NOT EXISTS target_water_liters DOUBLE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS target_sleep_hours DOUBLE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS target_workouts_per_week INT;
ALTER TABLE users ADD COLUMN IF NOT EXISTS target_active_calories DOUBLE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS target_distance_km DOUBLE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS is_verified BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS verification_requested BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS target_weight_kg DOUBLE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS age INT;
ALTER TABLE users ADD COLUMN IF NOT EXISTS height_cm DOUBLE;
ALTER TABLE users ADD COLUMN IF NOT EXISTS weight_kg DOUBLE;
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS reset_token_expiry DATETIME(6);
ALTER TABLE users ADD COLUMN IF NOT EXISTS created_at DATETIME(6);

-- For Trainers table
ALTER TABLE trainers ADD COLUMN IF NOT EXISTS user_id BIGINT;
ALTER TABLE trainers ADD COLUMN IF NOT EXISTS is_verified BOOLEAN NOT NULL DEFAULT FALSE;
ALTER TABLE trainers ADD COLUMN IF NOT EXISTS verification_requested BOOLEAN NOT NULL DEFAULT FALSE;
